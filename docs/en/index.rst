...
Sediment is HypeProof's product surface for team memory, retrieval, grounded
answers, and session preservation. This documentation site publishes the
repository's current requirements, architecture notes, research, and dogfood
records.

Language
--------

* `Korean documentation <../index.html>`_

...
Single trigger for the self-healing flow. Dispatches `curator-medic` subagent.
...
- If medic returns `journal_overflow`, suggest `/curator:compact` next.

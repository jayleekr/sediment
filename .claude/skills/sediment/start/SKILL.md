...
Next: /sediment:status   for live state
      /sediment:medic    if any blocker failed
```
...
- Don't proceed to Ralph if P0 has 5+ blocker failures — fix those first via /sediment:fix.

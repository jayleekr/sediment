...
```
/sediment:learnings              # show recent (last 20 entries)
/sediment:learnings --tail N     # show last N entries
/sediment:learnings --add "<one-line lesson>"   # append manually
/sediment:learnings --grep <pattern>    # search
/sediment:learnings --stats             # count by pattern type
```
